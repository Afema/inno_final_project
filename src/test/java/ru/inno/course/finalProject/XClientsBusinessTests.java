...
public class XClientsBusinessTests {
    ...
    public void getCompaniesWithoutActiveFilter() throws SQLException {
        ...
        given()
                ...
                .body(company3)
                .contentType(ContentType.JSON)
                .when().patch(PropsHelper.getCompanyUrl() + "/status/" + idCompany3)
                .then().log().all()
                .statusCode(200);

        assertFalse(companyRepository.getCompanyByIdDB(idCompany3).getIsActive());

        List<Company> companies = given()
                .when()
    ...
    public void checkInvisibleInactiveEmployee() throws SQLException {
        ...
        List<Employee> employeesAfter = given()
                .when()
                .get(PropsHelper.getEmployeeUrl() + "?company=" + idCompany)
                .then()
                .extract()
    ...
    @Test
    @DisplayName("6.Добавить несколько сотрудников в существующую компанию.Получить список сотрудников")
    ...
    public void getEmployeeById() throws SQLException {
        ...
        var employeeResponse = given()
                .get(PropsHelper.getEmployeeUrl() + "/" + newEmployeeId_DB)
                .then();
    ...
    @Test
    @DisplayName("14.Добавить сотрудника в существующую компанию. Затем удалить компанию,запросить инфо сотрудника")
    @Tag("negative")
    public void getEmployeeDeletedCompany() throws SQLException {
        ...
        Employee employeeWithoutCompany = given()
